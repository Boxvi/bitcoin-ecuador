            ...
            <div className="flex items-start justify-between px-6 pt-8 pb-6">
                <div>
                    ...
                    <Typography className="font-normal text-blue-gray-600">
                        Mire las configuraciones del Dashboard
                    </Typography>
                </div>
                <IconButton
                    variant="text"
            ...
            <div className="py-4 px-6">
                <div className="mb-12">
                    <Typography variant="h6" color="blue-gray">
                        Colores internos del Menu Izquierdo
                    </Typography>
                ...
                <div className="mb-12">
                    <Typography variant="h6" color="blue-gray">
                        Tipos del Menu Izquierdo
                    </Typography>
                    <Typography variant="small" color="gray">
                        Eliga entre los tres tipos de colores para el menu izquierdo.
                    </Typography>
                    <div className="mt-3 flex items-center gap-2">
                        <Button
...
Configurator.displayName = "/src/widgets/layout/configurator";
